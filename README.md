...
```
NOTICE: The documentation is *painfully* unfinished right now, and in addition to that, it's currently on hold (for the most part, but it still may be occasionally updated in bursts). Please feel free to add your own documentation or update the existing stuff if you want, but this project is currently a solo effort and I want to focus more on the actual development side of things right now.
```
